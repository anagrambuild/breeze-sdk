async function testSDKwithdraw() {
  ...
  try {
    ...
    // Test 2: Create Withdraw Transaction (using new API)
    console.log('2. Testing withdraw transaction with new API...');
    const withdrawResult = await sdk.createWithdrawTransaction({
      fundId: 'DYUgGU88Fsyr2xmYAv2p8jXVPa3jrcUZmb36C8EgfpaW',
      shares: 10,
      all: false,
      userKey: '4Z9byLWE4DhH3KM84mjrkggkCxPuU8eBFgM44Enj41bh'
    });
    console.log('✅ Deposit result:', JSON.stringify(withdrawResult, null, 2));
    console.log('');

    // Test 3: Get Deposit Instructions (new endpoint)
    console.log('3. Testing withdraw instructions...');
    const withdrawInstructions = await sdk.getWithdrawInstructions({
      fundId: 'DYUgGU88Fsyr2xmYAv2p8jXVPa3jrcUZmb36C8EgfpaW',
      shares: 10,
      userKey: '4Z9byLWE4DhH3KM84mjrkggkCxPuU8eBFgM44Enj41bh'
    });
    console.log('✅ Deposit instructions:', JSON.stringify(withdrawInstructions, null, 2));
  } catch (error) {
